...
import pickle
datafile = f'/Users/senthilp/Desktop/label_names.pkl'
F = open(datafile, 'wb')
...
np.save('/Users/senthilp/Desktop/stcs.npy', stcs[0].data)

label_ts = mne.extract_label_time_course(
    stcs, labels, inv['src'], mode='mean_flip', return_generator=False)

import pickle
datafile = f'/Users/senthilp/Desktop/label_ts.pkl'
F = open(datafile, 'wb')
...
np.save('/Users/senthilp/Desktop/corr_ortho_true.npy', corr)
...
np.save('/Users/senthilp/Desktop/degree_ortho_true.npy', degree)
...
np.save('/Users/senthilp/Desktop/stc_ortho_true.npy', stc.data)
brain = stc.plot(
