...
freqBand = [np.arange(2, 7, 1),np.arange(8,14,1),np.arange(15, 25, 1),np.arange(30, 60, 2),np.arange(60, 120, 4)]
...
for subject in case_list:
    ...
    for i, freq in enumerate(freqBand):
        ...
        csd = csd_morlet(raw_MEG, frequencies=freq, n_jobs=1)
        ...
        all_corr = envelope_correlation(label_stc, combine='mean', orthogonalize="pairwise",log=True, absolute=True, verbose=None)
