...
#cases = '/home/senthilp/caesar/camcan/cc700/freesurfer_output/40to49.txt'
#cases = '/home/senthilp/caesar/camcan/cc700/freesurfer_output/50to59.txt'
#cases = '/home/senthilp/caesar/camcan/cc700/freesurfer_output/60to69.txt'
#cases = '/home/senthilp/caesar/camcan/cc700/freesurfer_output/70to79.txt'
...
for subject in case_list:
    ...
    csd = csd_morlet(raw_MEG, frequencies=[12,14], n_jobs=64)

    csd = csd.mean()

    filters = make_dics(raw_MEG.info, fwd, csd, noise_csd=csd, pick_ori='max-power')
    ...
    atlas = f'{subjects_dir}/{subject}/mri/shen_freesurfer.mgz'
    ...
    corrFile_npy = f'{outDIR}/shen_corr.npy'
    np.save(corrFile_npy, all_corr)

    a = np.load(corrFile_npy)
    my_dic = {"corr":a}
    corrFile_mat = f'{outDIR}/shen_corr.mat'
