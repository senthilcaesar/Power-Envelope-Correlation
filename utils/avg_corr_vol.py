    ...
    for freq in freqs:    
        for label in sensor:
            ...
            for i, subject in enumerate(case_list):
                ...
                corr_data_warp = f'{DATA_DIR}/{subject}_{freq}_{label}_{spacing}_antsWarped.nii.gz'
            ...
            output = f'{subjects_dir}/{case_name}_avg/{case_name}_{flag}_{freq}_{label}.nii.gz'
