...
for i in ${freqs[@]}; do
    ...
    /Applications/freesurfer/7.1.1/bin/freeview -f ${surf_dir}/lh.inflated:overlay=${lh_inflated}:overlay_threshold=${min},${mid},${max}:overlay_color='colorwheel','inverse' \
    ...
    /Applications/freesurfer/7.1.1/bin/freeview -f ${surf_dir}/rh.inflated:overlay=${rh_inflated}:overlay_threshold=${min},${mid},${max}:overlay_color='colorwheel','inverse' \
